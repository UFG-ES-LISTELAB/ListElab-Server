    ...
    public class QuestaoController : ControllerBase
    {
            ...
            )
        {
            ...
            if (tipo == 0)
            {
                ...
                return Ok(DtoResultado<JObject>.ObtenhaResultado(new { Discursiva = retorno, MultiplaEscolha = new List<JObject>() }, "Consulta realizada sem erros"));
            }
            else if (tipo == 1)
            {
                ...
                return Ok(DtoResultado<JObject>.ObtenhaResultado(new { Discursiva = new List<JObject>(), MultiplaEscolha = retorno }, "Consulta realizada sem erros"));
            }
            else
            {
                filtro.Tipo = TipoQuestao.Discursiva;
                ...
                return Ok(DtoResultado<JObject>.ObtenhaResultado(new { Discursiva = retornoQuestaoDiscursiva, MultiplaEscolha = retornoQuestaoMultiplaEscolha }, "Consulta realizada sem erros"));
            }
        }
    }
}